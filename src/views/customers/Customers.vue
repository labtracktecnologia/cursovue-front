<template>
   <div>
    ...
    <b-table striped hover :items="orderedItens"></b-table>
  </div>
</template>
...
export default {
    data: () => {
     return {
        items: [
          { id: 1, name: 'Dickerson', phone: 'Macdonald' , email: "john@doe.com.br" },
    ...
    computed: {
        orderedItens () {
          ...
          if (this.order == 'id') {
            ...
            const compare = (a, b) => (a.name > b.name) - (a.name < b.name)
